...
<%  // VALIDAR SOLO GERENTE
    ...
    if(rol.equals("Usuario Normal"))
    {
        ...
        response.sendRedirect("../MenuPrincipal/UsuarioNormal.jsp");
            ...
            //PURO INGENIERO B)
            if(usuario.equals("Ingeniero de Soporte")){
            response.sendRedirect("../MenuPrincipal/UsuarioNormal.jsp");
            }
        }
    }
            ...
            <section class="contenido wrapper">
                <div class="desarrollo">
                    ...
                    <div class="textoB">
                        ...
                        <br><br>
                        <a href="../Registro/Reporte.jsp">Elaborar reporte</a><br><br>
                        <a href="../Usuario/Historial.jsp">Historial de reportes enviados</a><br><br>
                        <a href="../Registro/EditarRep.jsp">Editar reportes</a>
                     </div>
                </div>
